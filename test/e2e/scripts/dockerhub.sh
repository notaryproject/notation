...
export NOTATION_E2E_REGISTRY_HOST_WITH_REFERRERS_API=""
export NOTATION_E2E_REGISTRY_HOST_WITHOUT_REFERRERS_API="docker.io/$DOCKER_USERNAME"
export NOTATION_E2E_REGISTRY_USERNAME="$DOCKER_USERNAME"
export NOTATION_E2E_REGISTRY_PASSWORD="$DOCKER_PASSWORD"
export NOTATION_E2E_REGISTRY_HOST_FOR_DOMAIN="docker.io/$DOCKER_USERNAME"
