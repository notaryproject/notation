...
require (
	...
	github.com/notaryproject/notation-core-go v0.1.0-alpha.3.0.20220929020818-b5df54c7465b
	github.com/notaryproject/notation-go v0.10.0-alpha.3.0.20220930021926-2e9630d549b7
