...
require (
	...
	github.com/notaryproject/notation-go v0.10.0-alpha.3.0.20221011063551-643cd38fb2cb
...
require (
	...
	github.com/notaryproject/notation-core-go v0.1.0-alpha.3.0.20220929020818-b5df54c7465b // indirect
