...
require (
	...
	github.com/notaryproject/notation-core-go v0.0.0-20220923044937-70115d5d5e51
	github.com/notaryproject/notation-go v0.10.0-alpha.3.0.20220923073303-d09480aa8927
