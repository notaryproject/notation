...
require (
	...
	github.com/notaryproject/notation-core-go v0.0.0-20220926064152-c65f5c6b3537
	github.com/notaryproject/notation-go v0.10.0-alpha.3.0.20220926065242-9f4d8598695b
